...
import com.example.springboot.service.FoundService;
...
public class FoundController {
    ...
    public Result selectAll(Item item){
        List<Item> list = foundService.selectAll(item);
    ...
    public Result selectById(@PathVariable Integer id){
        Item item = foundService.selectById(id);
    ...
    public Result selectList(Item item){
        List<Item> list = foundService.selectList(item);
        return Result.success(list);
    }
    ...
    public Result selectPage(Item item,
        ...
        PageInfo<Item> pageInfo = foundService.selectPage(item,page,size);
